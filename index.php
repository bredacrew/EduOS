...
<header>
    ...
    <div class="header-socials">
        <a href="https://instagram.com/eduos_social" class="social-link" aria-label="Instagram">
            <i class="fa-brands fa-instagram"></i>
        </a>
        <a href="https://tiktok.com/@eduos_" class="social-link" aria-label="TikTok">
    ...
    <div class="header-profile" id="header-profile">
        ...
        <div class="header-dropdown" id="header-dropdown">
            <a href="client/view/login.html" class="dropdown-item">
                <i class="fa-solid fa-right-to-bracket"></i>
                Login
            </a>
            <a href="client/view/register.html" class="dropdown-item dropdown-item--spaced">
...
<section class="hero">
    ...
    <div class="hero-cta-group">
        <a href="client/view/login.html" class="btn-primary">
        ...
        <!-- Da Rimuovere -->
        <a href="client/view/homepage.html" class="btn-primary">
            <i class="fa-solid fa-rocket"></i>
    ...
    <div class="section-inner">
        ...
        <div class="pricing-grid">
            ...
            <div class="plan-card reveal">
                ...
                <a href="client/view/login.html" class="plan-cta">Inizia Gratis</a>
            </div>
            ...
            <div class="plan-card featured reveal reveal-delay-2">
                ...
                <a href="client/view/login/index.php" class="plan-cta">Passa a Plus</a>
            </div>
        </div>
    </div>
</section>
